 ...
 * 
 * The vanilla Minimax algorithm always plays perfectly but it may occassionaly 
 * decide to make a move that will result in a slower victory or a faster loss.
 * For example, playing the move 0, 1 and the 7  gives the AI the opportunity 
 * to play a move at index 6. This would result in a victory on the diagonal.
 * But the AI does not choose this move, instead it chooses another one. It still wins
 * inevitably, but it chooses a longer route. By adding the depth into evaluation 
 * function, it allows the AI to pick the move that would make it win as soon as possible. 
 */
